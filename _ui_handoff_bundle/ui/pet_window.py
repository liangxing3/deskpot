...
class PetWindow(QWidget):
    ...
    def __init__(self, asset_manifest: AssetManifest, parent: QWidget | None = None) -> None:
        ...
        self.status_card.setStyleSheet(
            """
            QWidget {
                background: rgba(255, 249, 251, 236);
                border: 1px solid rgba(255, 207, 223, 180);
                border-radius: 14px;
            }
            """
        )
        ...
        self.stage_label.setStyleSheet("color: #5A5A5A; font-size: 11px; font-weight: 700;")
    ...
    def _build_status_row(self, label: str, color: str) -> QProgressBar:
        ...
        caption.setStyleSheet("color: #666666; font-size: 11px;")
