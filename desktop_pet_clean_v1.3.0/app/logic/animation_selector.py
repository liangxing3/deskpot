...
class AnimationSelector:
    ...
    def resolve_animation_path(self, key: PetAnimationKey) -> Path | None:
...
class AnimationManager:
    ...
    def _build_transition(self, key: PetAnimationKey) -> AnimationTransition:
        return AnimationTransition(
            key=key,
            path=self.selector.resolve_animation_path(key),
