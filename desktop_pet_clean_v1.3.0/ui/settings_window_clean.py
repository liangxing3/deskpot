...
class SettingsWindow(DialogShell):
    ...
    def _build_ui(self) -> None:
        ...
        auto_start_row = self._setting_row("开机启动", "让桌宠随系统一起启动")
        ...
        hourly_row = self._setting_row("整点报时", "每小时整点给出一次提醒")
...
from ui.settings_window import SettingsWindow as _CanonicalSettingsWindow

SettingsWindow = _CanonicalSettingsWindow
