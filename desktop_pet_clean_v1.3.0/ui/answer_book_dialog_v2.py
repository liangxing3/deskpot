...
class AnswerBookDialogV2(DialogShell):
    ...
    def _card(*, background: str, border_alpha: int = 90, radius: int = Metrics.RADIUS_MD) -> QWidget:
        ...
        card.setStyleSheet(
            ...
            f"border: 1px solid {_rgba(Colors.BORDER_DEFAULT, border_alpha)};"
...
def _chip_stylesheet() -> str:
    ...
    QPushButton {{
        ...
        border: 1px solid {_rgba(Colors.BORDER_DEFAULT, 90)};
        border-radius: 15px;
    ...
    QPushButton:disabled {{
        ...
        border-color: {_rgba(Colors.BORDER_DEFAULT, 56)};
    }}
    """
...
def _answer_surface_stylesheet() -> str:
    ...
    QLabel {{
        ...
        border: 1px dashed {_rgba(Colors.BLUSH, 220)};
        border-radius: {Metrics.RADIUS_MD}px;
        padding: 18px 16px;
        color: {Colors.TEXT_PRIMARY.name()};
        font-size: 18px;
