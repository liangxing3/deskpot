...
- 复制一份不含用户数据的干净源码副本到 `desktop_pet_clean_release`
- 重新生成 `dist/DesktopPetAssistantV1`
- 重新生成安装包 `installer/DesktopPetAssistantV1-Setup-v1.3.1.exe`
- 额外生成便携压缩包 `installer/DesktopPetAssistantV1-Portable-v1.3.1.zip`
