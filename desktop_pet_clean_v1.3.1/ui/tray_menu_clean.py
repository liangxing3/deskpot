...
class TrayMenu(QObject):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.tray_icon = QSystemTrayIcon(make_icon("pet", size=24), parent)

        self.menu = QMenu()
        self.menu.setStyleSheet(menu_stylesheet(13))

        self.toggle_action = self.menu.addAction(make_icon("pet"), "显示 / 隐藏桌宠")
        ...
        self.tray_icon.setToolTip("Desktop Pet Assistant V1")
...
from ui.tray_menu import TrayMenu as _CanonicalTrayMenu

TrayMenu = _CanonicalTrayMenu
